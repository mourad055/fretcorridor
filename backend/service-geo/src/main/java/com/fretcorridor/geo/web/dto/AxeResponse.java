...
public record AxeResponse(
        ...
        double hubOrigineLatitude,
        double hubOrigineLongitude,
        UUID hubDestinationId,
        String hubDestinationNom,
        String hubDestinationVille,
        double hubDestinationLatitude,
        double hubDestinationLongitude,
    ...
    public static AxeResponse from(Axe axe) {
        return new AxeResponse(
                ...
                axe.getHubOrigine().getPosition().getY(),
                axe.getHubOrigine().getPosition().getX(),
                axe.getHubDestination().getId(),
                axe.getHubDestination().getNom(),
                axe.getHubDestination().getVille(),
                axe.getHubDestination().getPosition().getY(),
                axe.getHubDestination().getPosition().getX(),
