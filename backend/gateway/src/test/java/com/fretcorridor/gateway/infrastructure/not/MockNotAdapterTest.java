...
class MockNotAdapterTest {
    ...
    void tenant_filter_returns_only_its_own_notifications() {
        StepVerifier.create(adapter.listerNotificationsParTenant("tenant-bgft-douala", "token-demo").collectList())
    ...
    void a_tenant_with_no_notification_gets_an_empty_list() {
        StepVerifier.create(adapter.listerNotificationsParTenant("tenant-inconnu", "token-demo").collectList())
