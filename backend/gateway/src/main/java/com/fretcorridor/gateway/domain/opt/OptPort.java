...
public interface OptPort {
    ...
    Flux<MissionAppariee> listerMissionsParTenant(String tenantId, String delegationToken);
    ...
    Mono<ObservatoireAxeVue> observatoirePourAxe(String tenantId, String axeId, String delegationToken);
    ...
    Mono<Void> definirEstimationMarche(String tenantId, String axeId, BigDecimal volumeMensuelEstime, String source,
                                        String acteurId, String delegationToken);
    ...
    Flux<AlerteSeuilVue> listerAlertes(String tenantId, String delegationToken);

    Flux<EtatAlerteVue> etatAlertes(String tenantId, String delegationToken);

    Mono<Void> supprimerAlerte(String id, String tenantId, String delegationToken);
}
