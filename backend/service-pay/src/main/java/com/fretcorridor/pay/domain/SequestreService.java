...
public class SequestreService {
    ...
    public Sequestre declencher(String missionId) {
        ...
        Sequestre sequestre = new Sequestre(missionId, SequestreEtat.DECLENCHE, Instant.now(), null, null, null, null);
        sequestrePort.sauvegarder(sequestre);
        return sequestre;
    }

    /** RG-078 : {@code preuveLivraisonReference} est obligatoire — {@link Sequestre} le garantit par construction. */
    public Sequestre liberer(String missionId, String tenantId, String transporteurId, String preuveLivraisonReference) {
        ...
        Sequestre libere = new Sequestre(missionId, SequestreEtat.LIBERE, existant.declencheLe(), Instant.now(),
                tenantId, transporteurId, preuveLivraisonReference);
