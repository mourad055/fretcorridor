package com.flysoft.fretcorridor.cap.security;
...
// service-cap ne delivre aucun token - il valide ceux emis par service-ida,
// avec le meme secret partage. Meme pattern que service-opt/geo/mat/trk
// (PR #81) et service-not/service-exe/service-ida.
@Service
