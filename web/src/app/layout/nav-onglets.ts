...
const ONGLETS_BUREAU: OngletNav[] = [
  ...
  { path: '/bureau/affiliations', labelKey: 'nav.bureau.affiliations', exact: false, groupeKey: 'nav.groupe.exploitation' },
];
...
const ONGLETS_ADMIN: OngletNav[] = [
  ...
  { path: '/admin/notifications', labelKey: 'nav.admin.notifications', exact: false, groupeKey: 'nav.groupe.conformite' },
];
